...
public class StorageNode_TCP extends Thread{
	...
	public void run()
		...
		TCPR.start();//attivo il TCPReader, il quale si occuperà di accettare le richieste in ingresso ed aggiungere in list
		try
			...
			{try
				...
				for(int i=0;i<list.size();i++)
					...
					//ma una socket TCP creta dall'oggetto che gestisce l'UDP del nodo di bootstrap che si è occupato del client
						...
						System.out.println("dato da cercare="+id_data);
