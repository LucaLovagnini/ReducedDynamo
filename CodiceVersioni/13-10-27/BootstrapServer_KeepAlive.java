			...
			while(true)
				...
				try
					{while(true)
						...
						bw.write(date+" Ricevuto messaggio "+messList.get(messList.size()-1));
						bw.newLine();
						}
					}
				catch(SocketTimeoutException e)//Timeout!
					{bw.write(date+" Timeout");
					bw.newLine();
					bw.newLine();
					bw.flush();}
				catch(Exception e){e.printStackTrace();}
				...
				bw.write(date+" Tabella BootstrapNode:");
				bw.newLine();
				for(int i=0;i<storageNodeList.size();i++)
					{bw.write(date+" "+storageNodeList.get(i));
					bw.newLine();
					}
				bw.newLine();
				bw.flush();
				...
				bw.write(date+" Tabella BootstrapNode Aggiornata:");
				bw.newLine();
				for(int i=0;i<storageNodeList.size();i++)
					{bw.write(date+" "+storageNodeList.get(i));
					bw.newLine();
