...
public class StorageNode_KeepAlive extends Thread{
	...
	public StorageNode_KeepAlive(String fakeip,String bootstrapServerIp,ScannerPorte scanner)
		{this.setDaemon(true);
		this.fakeip=fakeip;
		this.scanner=scanner;
		this.bootstrapServerIp=bootstrapServerIp;
		}
	public StorageNode_KeepAlive(String fakeip,ScannerPorte scanner)
	{this.fakeip=fakeip;
	...
	public void run()
		...
		catch(SocketTimeoutException e){System.out.println(fakeip+" Nessuna risposta!");}
